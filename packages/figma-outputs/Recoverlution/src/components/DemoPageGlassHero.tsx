/**
 * DEMO PAGE GLASS HERO
 * 
 * Mission: Full-bleed hero with glass treatment for Demo/Booking page
...
const dashboardMockup = PLATFORM_MOCKUPS.dashboard.url;

export function DemoPageGlassHero() {
  return (
    <section 
    ...
    >
      <div className="max-w-[1600px] mx-auto px-6 md:px-12">
        ...
        <div className="relative" style={{ borderRadius: '0px' }}>
          ...
          {/* Full-Bleed Platform Mockup Background */}
          <div className="relative aspect-[16/9] lg:aspect-[21/9] overflow-hidden" style={{ 
            ...
            <motion.img 
              src={dashboardMockup}
              alt="Recoverlution Platform Dashboard - Book your personalized demo"
            ...
            >
              ...
              <div className="relative p-10 lg:p-12">
                ...
                >
                  Schedule a personalized 30-minute walkthrough and see how neuroscience-backed recovery drives measurable outcomes.
                </motion.p>
