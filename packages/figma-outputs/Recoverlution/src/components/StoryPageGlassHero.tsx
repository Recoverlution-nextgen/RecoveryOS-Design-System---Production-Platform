/**
 * STORY PAGE GLASS HERO
 * 
 * Mission: Full-bleed hero with glass treatment for Story page
...
import danielPhoto from "figma:asset/5af846b0e5f641b91f40e88c1fb6989cb5e845da.png";

export function StoryPageGlassHero() {
  return (
    <section 
      ...
      <div className="max-w-[1600px] mx-auto px-6 md:px-12">
        ...
        <div className="relative" style={{ borderRadius: '0px' }}>
          ...
          <div className="relative aspect-[16/9] lg:aspect-[21/9] overflow-hidden" style={{ 
            ...
            <motion.img 
              src={danielPhoto}
              alt="Daniel Fincham - Founder building recovery technology from lived experience"
              className="w-full h-full object-cover"
              style={{ position: 'absolute', inset: 0, zIndex: 1, objectPosition: 'center 30%' }}
            ...
            >
              ...
              <div className="relative p-10 lg:p-12">
                ...
                >
                  Our story began with a simple question: What if we could turn neuroscience research into technology that actually works in the real world of recovery?
                </motion.p>
