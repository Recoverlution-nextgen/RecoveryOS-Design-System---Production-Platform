...
const meta = {
  ...
  tags: ['autodocs'],
} satisfies Meta<typeof ConductorView>;

export default meta;
type Story = StoryObj<typeof meta>;

export const IndividualRouting: Story = {
  args: {
...
export const IndividualWithWhy: Story = {
  args: {
...
export const ProfessionalConnection: Story = {
  args: {
...
export const OrganisationQuietHours: Story = {
  args: {
    signals: ['anchorage'],
    inputsVisible: 'minimal',
    whyDrawer: false,
...
export const DeliveryState: Story = {
  args: {
