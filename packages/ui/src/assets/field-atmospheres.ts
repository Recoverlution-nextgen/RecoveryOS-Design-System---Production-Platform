 ...
 */
export const GRAIN_FIELD: AssetWithFamily = {
 ...
 */
export const BREATH_GRADIENT: AssetWithFamily = {
 ...
 */
export const NOISE_SHIMMER: AssetWithFamily = {
 ...
 */
export const CONTINUITY_VEIL: AssetWithFamily = {
 ...
 */
export const HEAT_HAZE: AssetWithFamily = {
 ...
 */
export const FIELD_ATMOSPHERE_ASSETS: AssetWithFamily[] = [
  GRAIN_FIELD,
  BREATH_GRADIENT,
  NOISE_SHIMMER,
  CONTINUITY_VEIL,
