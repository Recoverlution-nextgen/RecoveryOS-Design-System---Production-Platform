 ...
 */
export const SENSE_ROUTE_DELIVER_SEAL_HERO = createHeroAsset('hero-sense-route-deliver-seal', 'sense-route-deliver-seal', 'Sense → Route → Deliver → Seal', 'The core RecoveryOS loop: Sense state, Route to primitive, Deliver intervention, Seal proof of shift', `<svg viewBox="0 0 1200 600" xmlns="http://www.w3.org/2000/svg">
    <defs>
  ...
  </svg>`, 'Sense → Route → Deliver → Seal', ['companion', 'console', 'command']);
/**
 * ERA Cadence Hero (Experience → Recognise → Align)
 */
export const ERA_CADENCE_HERO = createHeroAsset('hero-era-cadence', 'era-cadence', 'Experience → Recognise → Align', 'The weekly recovery cadence: Experience the loop, Recognise patterns, Align to what works', `<svg viewBox="0 0 1200 600" xmlns="http://www.w3.org/2000/svg">
    <defs>
  ...
  </svg>`, 'Experience → Recognise → Align', ['companion', 'console']);
/**
 * Three Altitudes Hero (Individual/Professional/Organisational)
 */
export const THREE_ALTITUDES_HERO = createHeroAsset('hero-three-altitudes', 'three-altitudes', 'Three Altitudes', 'RecoveryOS scales across three perspectives: Individual (Companion), Professional (Console), Organisational (Command)', `<svg viewBox="0 0 1200 600" xmlns="http://www.w3.org/2000/svg">
    <defs>
  ...
  </svg>`, 'Individual → Professional → Organisational', ['command']);
/**
 * Proof Stacking Asset (medium-sized narrative visual)
 */
export const PROOF_STACKING_ASSET = createAssetWithEtchedCopy('asset-proof-stacking', 'proof-stacking', 'Proof Stacking', 'Evidence accumulates: Each sealed delivery creates immutable proof that stacks over time', `<svg viewBox="0 0 400 300" xmlns="http://www.w3.org/2000/svg">
    <defs>
  ...
  </svg>`, 'Stack proof\nBuild evidence', 'neutral', { width: 400, height: 300 });
/**
