 ...
 */
export const PROOF_RECEIPT: AssetWithFamily = {
 ...
 */
export const VAULT_CARD: AssetWithFamily = {
 ...
 */
export const TIMELINE_PASS: AssetWithFamily = {
 ...
 */
export const OS_OBJECT_ASSETS: AssetWithFamily[] = [
  PROOF_RECEIPT,
  VAULT_CARD,
  TIMELINE_PASS,
];
